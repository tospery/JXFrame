...
@interface JXPageMenuTitleItem : JXPageMenuIndicatorItem
...
@property (nonatomic, assign) JXPageMenuTitleLabelAnchorPointStyle titleLabelAnchorPointStyle;
